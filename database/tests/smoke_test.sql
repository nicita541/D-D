...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'FAIL 10: campaign_template was not created';
    END IF;
END;
$$;

SELECT 'OK 09: campaign_template created' AS check, campaign_template_id
FROM smoke_context;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'FAIL 11: story_state was not created for the game_state';
    END IF;
END;
$$;

SELECT 'OK 10: story_state created for game_state' AS check, story_state_id
FROM smoke_context;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'FAIL 12: party or party_member was not created correctly';
    END IF;
END;
$$;

SELECT 'OK 11: party and party_member created' AS check, party_id, party_member_id
FROM smoke_context;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'FAIL 13: combat_state or combat_participant was not created correctly';
    END IF;
END;
$$;

SELECT 'OK 12: combat_state and combat_participant created' AS check, combat_state_id, combat_participant_id
FROM smoke_context;

SELECT
    'OK 13: RPG extension table SELECT checks passed' AS check,
