...
public sealed class AllApiSurfaceContractTests
{
    ...
    public void Api_Surface_Has_Core_Rpg_Endpoints()
    {
        ...
        var required = new[]
        {
            ...
            "POST api/game-states/{gameStateId:guid}/play/act",
            "POST api/game-states/{gameStateId:guid}/play/start",
            "POST api/game-states/{gameStateId:guid}/play/message",
            "POST api/game-states/{gameStateId:guid}/play/resolve-mechanic-request/{requestId:guid}",
            "POST api/game-states/{gameStateId:guid}/play/resolve-and-continue/{requestId:guid}",
            "POST api/game-states/{gameStateId:guid}/play/continue",
            "POST api/game-states/{gameStateId:guid}/play/apply-change/{changeId:guid}",
            "POST api/game-states/{gameStateId:guid}/play/reject-change/{changeId:guid}",
            "POST api/game-states/{gameStateId:guid}/play/apply-safe-changes",
            "POST api/game-states/{gameStateId:guid}/play/travel",
            "POST api/game-states/{gameStateId:guid}/play/location/move",
            "POST api/game-states/{gameStateId:guid}/play/combat/start",
            ...
            "POST api/game-states/{gameStateId:guid}/characters/{characterId:guid}/inventory/items",
            "POST api/game-states/{gameStateId:guid}/characters/{characterId:guid}/inventory/items/{itemId:guid}/equip",
            "POST api/game-states/{gameStateId:guid}/characters/{characterId:guid}/inventory/items/{itemId:guid}/unequip",
            "POST api/game-states/{gameStateId:guid}/characters/{characterId:guid}/inventory/items/{itemId:guid}/use",
            "DELETE api/game-states/{gameStateId:guid}/characters/{characterId:guid}/inventory/items/{itemId:guid}",
